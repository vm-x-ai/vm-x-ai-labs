...
import type { AIExtractionProjectGeneratorArgs } from './commands';
import {
...
import type { CloudProviders, MonorepoTools, ProgrammingLanguages } from './types';
import { promptConfirmIfUndefined, promptIfUndefined, type EnquirerChoice } from './utils/enquirer';
